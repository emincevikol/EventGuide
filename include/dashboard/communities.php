          ...
          <div id="page-wrapper">
            <?php if ($_SESSION['admin']){ ?>
                <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                          ...
                          <ol class="breadcrumb">
                              ...
                              <li class="active">
                                  <i class="fa fa-file"></i>  Toplulukar
                              </li>
                          </ol>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <div class="row">
                      <button  type="button" class="btn btn-primary btn-lg pull-right" data-toggle="modal" data-target="#addcommunity">Topluluk Ekle</button>
                    </div>
                    <div class="row">
                                      ...
                                      if($row>0)
                                      {
                                         ...
                                         ?>
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-success pull-right" style=" margin-left: 10px;" data-toggle="modal" data-target="#editclubs"  onclick="Javascript:EditClub('<?=$inf["id"];?>','<?=$presidentId;?>', 2);">Düzenle</button>
                                                <button type="button" class="btn btn-info pull-right" style=" margin-left:5px;" data-toggle="modal" data-target="#clubdetails" onclick="Javascript:ClubDetails('<?=$inf["id"];?>','2');">Detay</button>
                                            </td>
                                    </tr>
                                    <?php
                                    $counter++;
