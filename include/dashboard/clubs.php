            ...
            <?php if ($_SESSION['admin']){ ?>
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-lg-12">
                          ...
                          <ol class="breadcrumb">
                              ...
                              <li class="active">
                                  <i class="fa fa-file"></i> Student Clubs
                              </li>
                          </ol>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <div class="row">
                      <?php $type=1; ?>
                      <button type="button" class="btn btn-primary btn-lg pull-right" data-toggle="modal" data-target="#addclub" style="    width: 200px;">Add New Club</button>
                      <?php include("include/modal.php");  ?>
                    </div>
                    <div class="row">
                        ...
                        <tbody>
                          ...
                          ?><tr>
                              ...
                              $result2 = mysqli_query($con, $sql2);
                                 ...
                                 ?>
                                    <td><button type="button" class="btn btn-danger pull-right" style=" margin-left: 10px;"  data-target="#delete" onclick="Javascript:Delete('<?=$inf["id"];?>', '1');">Delete</button>
                                        ...
                                        <button type="button" class="btn btn-success pull-right" style=" margin-left: 10px;" data-toggle="modal" data-target="#editclubs"  onclick="Javascript:EditClub('<?=$inf["id"];?>','<?=$presidentId?>',1);">Edit</button>
                                    </td>
                            </tr>
                            <?php
                            $counter++;
